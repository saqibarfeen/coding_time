fig10x003<-function(){
#
# Requires textbook R data set Galton.RData which contains
# dataframe Galton
#
graphics.off()
...
xlim=c(55,75),ylim=c(60,80),
seg.col="black",cex=0.5,cex.fact=1.0,seg.lwd=1.,
size=1/16,rotate=FALSE)
#
dev.copy2eps(file="fig10x003.eps")
dev.copy2pdf(file="fig10x003.pdf")
}
