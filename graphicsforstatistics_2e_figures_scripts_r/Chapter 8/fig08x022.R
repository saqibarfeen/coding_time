fig08x022<-function(){
haireyex<-matrix(data=c(94,16,10,7,NA,17,14,14,
26,NA,84,29,54,119,NA,20,5,15,68,NA),
nrow=4,ncol=5,byrow=TRUE,
dimnames=list(c("Blond","Red","Brunette","Black"),
c("Blue","Green","Hazel","Brown"," ")))
#
haireye<-t(haireyex[1:4,1:4])
haireye<-haireye/apply(haireye,1,sum)
haireye<-t(haireye)
haireye
...
las=1,padj=0,col=0)
#
dev.copy2eps(file="fig08x022.eps")
dev.copy2pdf(file="fig08x022.pdf")
}
