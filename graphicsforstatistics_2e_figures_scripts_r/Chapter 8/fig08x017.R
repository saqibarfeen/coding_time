fig08x017<-function(){
haireyex<-matrix(data=c(94,16,10,7,17,14,14,26,84,
29,54,119,20,5,15,68,NA,NA,NA,NA),
...
#
axis(2,at=yy,labels=hc,font=1,tck=0,
tcl=0,las=1,padj=0,col=0)
#
dev.copy2eps(file="fig08x017.eps")
dev.copy2pdf(file="fig08x017.pdf")
}
