...
data=Perch)
#
crPlots(lmlog,col="black",line=TRUE,smoother=loessLine,
col.lines=c("black","black"),lwd=2,grid=FALSE,main="")
#
dev.copy2eps(file="fig13x019.eps")
dev.copy2pdf(file="fig13x019.pdf")
}
