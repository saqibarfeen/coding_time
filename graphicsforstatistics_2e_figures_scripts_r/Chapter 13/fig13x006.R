...
#
legend(x="top",legend=c("setosa","versicolor",
"virginica"),cex=0.75,x.intersp=0.5,bty="o",
inset=-0.025,col=colpal,pch=c(2,0,1),pt.cex=0.5,
horiz=TRUE)
#
dev.copy2eps(file="fig13x006.eps",colormodel="cmyk")
dev.copy2pdf(file="fig13x006.pdf",colormodel="cmyk")
}
