...
my.filled.contour(x, y, z, col = terrain.colors(100), nlevels=100,
...
dev.copy2eps(file="figaax004.eps",pointsize=10,colormodel="cmyk")
dev.copy2pdf(file="figaax004.pdf",pointsize=10,out.type="pdf",colormodel="cmyk")
}
