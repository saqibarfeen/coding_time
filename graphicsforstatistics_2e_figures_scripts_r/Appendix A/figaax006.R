...
my.filled.contour(x, y, z, 
    col = dichromat(terrain.colors(100),type="deutan"), nlevels=100,
...
dev.copy2eps(file="figaax006.eps",pointsize=10,colormodel="cmyk")
dev.copy2pdf(file="figaax006.pdf",pointsize=10,out.type="pdf",colormodel="cmyk")
}
