...
my.filled.contour(x, y, z, col = cm.colors(100), nlevels=100,
...
dev.copy2eps(file="figaax008.eps",pointsize=10,colormodel="cmyk")
dev.copy2pdf(file="figaax008.pdf",pointsize=10,out.type="pdf",colormodel="cmyk")
}
