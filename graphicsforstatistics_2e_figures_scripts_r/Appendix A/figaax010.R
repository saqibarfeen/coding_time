...
my.daltonize("standardcm",cvd = "t")

dev.copy2eps(file="figaax010.eps",pointsize=12,colormodel="cmyk")
dev.copy2pdf(file="figaax010.pdf",pointsize=12,out.type="pdf",colormodel="cmyk")
}
