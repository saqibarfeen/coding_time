...
my.filled.contour(x, y, z, col = gray((0:99)/99), nlevels=100,
...
dev.copy2eps(file="figaax013.eps",pointsize=10,colormodel="cmyk")
dev.copy2pdf(file="figaax013.pdf",pointsize=10,out.type="pdf",colormodel="cmyk")
}
