...
#
# spline density estimate
#
lines(spline(c(0,hist_mass$mids),
c(0,hist_mass$density),method="fmm"),lwd=1.5)
#
dev.copy2eps(file="fig06x029.eps")
dev.copy2pdf(file="fig06x029.pdf")
}
