...
box.umbrella=list(col="black",lty=5),
plot.symbol=list(pch=1,col="black",cex=0.8))
#
figure<-bwplot(type~width,widthf,xlab="Width (%)",
ylab=" ",horizontal=TRUE,
scales=list(x=list(limits=c(10,25),at=(2:5)*5,axs="i")),
panel=function(...,box.ratio) {
panel.violin(...,col="transparent",
varwidth=FALSE,box.ratio=box.ratio)
panel.bwplot(...,fill=NULL,box.ratio=.045,col="black",pch="|")
})
#
print(figure)
#
dev.copy2eps(file="fig06x027.eps")
dev.copy2pdf(file="fig06x027.pdf")
}
