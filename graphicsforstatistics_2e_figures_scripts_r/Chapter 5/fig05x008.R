...
mai=c(0.85,0.75,0.25,0.05),xaxs="r",bty="n")
#
qqnorm(mass,main=NULL,xaxt="n",
xlim=c(-4,4),ylim=c(0,1200),ylab = "Mass (g)",
...
axis(1,zprob,lprob)
#
dev.copy2eps(file="fig05x008.eps")
dev.copy2pdf(file="fig05x008.pdf")
}
