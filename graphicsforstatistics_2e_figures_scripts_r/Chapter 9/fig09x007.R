...
#
boxplot(Weight ~ Species,data=fc,ylim=c(0,2000),
xlab="Mass (g)",horizontal=TRUE,las=1,notch=TRUE,
varwidth=TRUE)
#
dev.copy2eps(file="fig09x007.eps")
dev.copy2pdf(file="fig09x007.pdf")
}
