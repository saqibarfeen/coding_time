...
abline(v=200*(0:4))
axis(1,tick=FALSE,yaxp=c(0,800,200),labels=TRUE)
yy<-1.5*(1:length(amount)-.375)
axis(2,at=yy+0.2,labels=item,tck=0,tcl=0,col=0,las=2,
hadj=0,outer=TRUE,line=-2)
box()
#
dev.copy2eps(file="fig02x010.eps")
dev.copy2pdf(file="fig02x010.pdf")
}
