...
#
barplot(amount,space=0.5,
names.arg=NULL,horiz=TRUE,axes=FALSE,xlim=c(0,800),
xlab="Millions of US Dollars",col="white")
#
...
#
dev.copy2eps(file="fig02x013.eps")
dev.copy2pdf(file="fig02x013.pdf")
}