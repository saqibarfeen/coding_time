...
text(x=yy-0.2,y=-50,labels=item,
offset=0,srt=45,adj=c(1.0,1.0),xpd=TRUE)
#
dev.copy2eps(file="fig02x006.eps")
dev.copy2pdf(file="fig02x006.pdf")
}
