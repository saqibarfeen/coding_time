...
#
graphics.off()
windows(width=4.5,height=4.7,pointsize=12)
par(fin=c(4.45,4.65),pin=c(4.45,4.65),
mai=c(0.85,2.1,0.25,0.25))
#
...
axis(3,tick=TRUE,yaxp=c(0,800,200),labels=FALSE)
yy<-1.5*(1:length(amount)-.375)
axis(2,at=yy+0.2,labels=item,tck=0,tcl=0,col=0,
las=2,hadj=0,outer=TRUE,line=-2)
box()
#
dev.copy2eps(file="fig02x009.eps")
dev.copy2pdf(file="fig02x009.pdf")
}