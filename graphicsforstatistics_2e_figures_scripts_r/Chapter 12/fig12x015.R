...
xlim=c(64,76),ylim=c(64,76),
pch=21,cex=0.5)
#
abline(coef(molm),lty=2)
#
lines(lowess(MidParent,MidOffspring,delta=0))
#
dev.copy2eps(file="fig12x015.eps")
dev.copy2pdf(file="fig12x015.pdf")
}
