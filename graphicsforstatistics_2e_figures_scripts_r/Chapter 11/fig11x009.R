...
#
plot(MidParent,res,xlab="Mid-Parent Height (inch)",
ylab="Residual (inch)",xlim=c(60,80),pch=21,cex=0.5,
ylim=c(-5,5))
#
abline(c(0,0),lty=2)
#
dev.copy2eps(file="fig11x009.eps")
dev.copy2pdf(file="fig11x009.pdf")
}
