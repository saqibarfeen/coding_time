...
#
plot(MidParent,dffits(molm),
xlab="Mid-Parent Height (inch)",ylab="DFFITS",
xlim=c(60,75),ylim=c(-0.4,0.4),cex=0.5)
#
abline(c(2*sqrt(2/length(MidParent)),0),lty=2)
abline(-c(2*sqrt(2/length(MidParent)),0),lty=2)
#
text(67.25,0.3,"High Leverage")
text(67.25,-0.325,"High Leverage")
#
dev.copy2eps(file="fig11x019.eps")
dev.copy2pdf(file="fig11x019.pdf")
}
