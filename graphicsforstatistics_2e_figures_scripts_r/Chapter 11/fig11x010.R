...
#
plot(MidOffspring,res,
xlab="Mid-Offspring Height (inch)",
ylab="Residual (inch)",xlim=c(60,80),
pch=21,cex=0.5,ylim=c(-5,5))
#,seg.col="black",cex.fact=3,seg.lwd=1.,size=1/16,rotate=TRUE)
#
abline(c(0,0),lty=2)
#
dev.copy2eps(file="fig11x010.eps")
dev.copy2pdf(file="fig11x010.pdf")
}
