...
#
#sunflower
plot(MidParent,MidOffspring,
xlab="Mid-Parent Height (inch)",
ylab="Mid-Offspring Height (inch)",
xlim=c(60,80),ylim=c(60,80),pch=21,cex=0.5)
#seg.col="black",cex.fact=3,seg.lwd=1.,size=1/16,rotate=TRUE)
#
abline(coef(molm))
#
segments(MidParent,MidOffspring,MidParent,
coeffs[1]+MidParent*coeffs[2])
#
dev.copy2eps(file="fig11x008.eps")
dev.copy2pdf(file="fig11x008.pdf")
}
